export function renderAppShell() {
  ...
  <div class="friends-sidebar" id="friends-sidebar">
    ...
    <div id="friends-settings-panel" class="mods-content-wrapper" style="display:none;">
      ...
      <div id="friends-sidebar-chat-panel" class="friends-chat-panel" style="display:none; flex-direction:column; height: 100%;">
        <!-- Chat Header -->
        <div class="friends-chat-header">
          ...
          <div class="friends-chat-info">
            <div class="friend-avatar" style="width:24px;height:24px;">
              <canvas id="friends-chat-avatar-side" width="24" height="24" style="image-rendering:pixelated;width:100%;height:100%;"></canvas>
            </div>
            <div class="friend-info">
              <strong id="friends-chat-name-side" style="font-size:0.7812rem;">Friend Name</strong>
              <span id="friends-chat-status-side" class="friend-status-text" style="font-size:0.5625rem;">Online</span>
            </div>
          </div>
        </div>
      </div>
